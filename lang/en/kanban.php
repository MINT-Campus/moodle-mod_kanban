...
$string['addcardshere'] = 'Allow adding cards in this column';
...
$string['addingcardsallowed'] = 'Adding new cards is allowed in this column';
...
$string['cardlinkcopied'] = 'Link copied to clipboard';
...
$string['collimit'] = 'Column limit';
$string['collimitenable'] = 'Enable limit for cards in this column';
$string['collimitgreaterzero'] = 'limit needs to be greater than zero';
$string['collimitreached'] = 'Column "{$a->coltitle}" may have at most {$a->limit} cards';
$string['colmax'] = 'Maximum amount of cards in this column';
$string['color'] = 'Color';
...
$string['exportboard'] = 'Export board';
$string['filtersearch'] = 'Search card titles';
$string['filtersearchplaceholder'] = 'Search card titles...';
...
$string['showauthors'] = 'Show authors of cards';
$string['showauthors_help'] = 'If option is selected, the original authors are displayed on the bottom of the cards.';
